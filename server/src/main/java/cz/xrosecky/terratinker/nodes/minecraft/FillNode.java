...
public class FillNode extends AbstractActionNode {

    public FillNode(String id, JSONObject json) {
        super(id, json);
    }
    ...
    public AbstractNode evaluate(Program program, EvaluationState tree) {
        return super.actionRoutine(program, tree, (inputs, output) -> {
            ...
            if (minXF == null || minYF == null || minZF == null || maxXF == null || maxYF == null || maxZF == null || material == null) {
                return;
            }
